...
| crowding | 1 / n² | Where `n` counts eligible results that are also recent. When everything is recent, recency identifies nothing — each rival both dilutes the signal and raises the cost of acting on it. |
